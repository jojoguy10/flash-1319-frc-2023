...
public class IntakeSubsystem extends SubsystemBase {
    private DoubleSolenoid m_intake = new DoubleSolenoid(10, PneumaticsModuleType.REVPH, 4, 2);
    ...
    public void periodic() {
        SmartDashboard.putBoolean("Gripper Limit Switch", !gripperLimitSwitch.get());
